@extends('layouts.default')
    ...
    @section('meta')
        <title>Leave Types | Attendance Time Clock</title>
        <meta name="description" content="Attendance leave type, view leave types, add or edit leave types and export or download leave types.">
    @endsection

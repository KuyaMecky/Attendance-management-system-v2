@extends('layouts.default')
    ...
    @section('meta')
        <title>Leave Groups | Attendance Time Clock</title>
        <meta name="description" content="Attendance leave groups, view leave groups, add leave groups, and edit leave groups.">
    @endsection

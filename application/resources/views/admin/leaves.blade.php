@extends('layouts.default')
    ...
    @section('meta')
        <title>Leave of Absence | Attendance Time Clock</title>
        <meta name="description" content="Attendance leave of absence, view all employee leaves of absence, edit, comment, and approve or deny leave requests.">
    @endsection 

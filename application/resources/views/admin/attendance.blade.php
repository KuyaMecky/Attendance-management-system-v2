@extends('layouts.default')
    ...
    @section('meta')
        <title>Attendance | Attendance Time Clock</title>
        <meta name="description" content="Attendance attendance, view all employee attendances, clock-in, edit, and delete attendances.">
    @endsection

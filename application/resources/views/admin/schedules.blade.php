@extends('layouts.default')
    ...
    @section('meta')
        <title>Schedules | Attendance Time Clock</title>
        <meta name="description" content="Attendance schedules, view all employee schedules, add schedule or shift, edit, and delete schedules">
    @endsection

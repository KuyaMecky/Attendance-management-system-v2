@extends('layouts.default')
    ...
    @section('meta')
        <title>Employee Roles | Attendance Time Clock</title>
        <meta name="description" content="Attendance roles, view all employee roles, add roles, edit roles, and delete roles.">
    @endsection

@extends('layouts.default')
    ...
    @section('meta')
        <title>Dashboard | Attendance Time Clock</title>
        <meta name="description" content="Attendance dashboard, view recent attendance, recent leaves of absence, and newest employees">
    @endsection

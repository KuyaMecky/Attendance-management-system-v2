@extends('layouts.default')
    ...
    @section('meta')
        <title>Employees | Attendance Time Clock</title>
        <meta name="description" content="Attendance employees, view all employees, add, edit, delete, and archive employees.">
    @endsection

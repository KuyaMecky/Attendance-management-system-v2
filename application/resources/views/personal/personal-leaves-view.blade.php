@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Leave | Attendance Time Clock</title>
        <meta name="description" content="Attendance my leave of absence, view my leave of absence records, edit pending leave request, and request leave of absence">
    @endsection

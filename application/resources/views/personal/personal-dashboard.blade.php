@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Dashboard | Attendance Time Clock</title>
        <meta name="description" content="Attendance my dashboard, view recent attendance, view recent leave of absence, and view previous schedules">
    @endsection

@extends('layouts.personal')
    ...
    @section('meta')
        <title>My Schedules | Attendance Time Clock</title>
        <meta name="description" content="Attendance my schedules, view my schedule records, view present and previous schedules.">
    @endsection
